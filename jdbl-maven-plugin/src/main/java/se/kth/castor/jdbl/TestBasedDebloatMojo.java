...
public class TestBasedDebloatMojo extends AbstractMojo {
    ...
    public void execute() {
        ...
        se.kth.castor.jdbl.wrapper.JacocoWrapper jacocoWrapper = new se.kth.castor.jdbl.wrapper.JacocoWrapper(project,
                new File(project.getBasedir().getAbsolutePath() + "/target/report.xml"),
                se.kth.castor.jdbl.wrapper.DebloatTypeEnum.TEST_DEBLOAT);
        ...
        se.kth.castor.jdbl.debloat.AbstractMethodDebloat testBasedMethodDebloat = new se.kth.castor.jdbl.debloat.TestBasedMethodDebloat(outputDirectory, usageAnalysis);
        try {
